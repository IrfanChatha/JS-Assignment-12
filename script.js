...
// for (let i = 0; i < abcString.length; i++)
// {
//  if (/[a,e,i,o,u,A,E,I,O,U]/.test(abcString[i])) {
//    vowels++;
// } else if (/[ ]/.test(abcString[i])) {
//    spaace++;
// }
// else {
//    consonant++;
...
//   }
// console.log(WordCount(abcString));
...
// {
//     for (let i = abcString.length-1; i >= 0 ; i--){
//     revStr += str[i];
// }
//     return revStr;
// }
// console.log(reverseStr(abcString));
